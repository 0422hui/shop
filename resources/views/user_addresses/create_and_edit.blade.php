  ...
  <div class="card-body">
    ...
    <user-addresses-create-and-edit inline-template>
            ...
            @endif
              {{ csrf_field() }}
      <!-- 注意这里多了 @change -->
      <select-district :init-value="{{ json_encode([$address->province, $address->city, $address->district]) }}" @change="onDistrictChanged" inline-template>          <div class="form-group row">
